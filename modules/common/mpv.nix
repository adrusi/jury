...
lib.mkMerge [
  # the usoc package fails to correctly install fonts on macOS
...

  {
    ...
    home-manager.users.${config.system.primaryUser} = {
      programs.firefox = {
        profiles.default.extensions.packages = [ inputs.firefox-addons.packages.${pkgs.system}.ff2mpv ];
      ...
      programs.mpv = {
        ...
        config = {
          ...
          demuxer-lavf-o = "activation_bytes=a1ac3e08";
        ...
        extraInput = ''
          ...
          Meta+r script-binding quality_menu/reload
        '';
        ...
        scripts = [
          ...
          pkgs.mpvScripts.builtins.acompressor
        ];
        ...
        scriptOpts = {
          thumbfast = {
            ...
            hwdec = true;
            direct_io = false;
            mpv_path = "${lib.getBin pkgs.mpv}/bin/mpv";
          };
